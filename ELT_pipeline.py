...
project_id = 'custom-vigil-346206'
dataset_id = '.health_data_global'
...
with DAG(
    ...
    load_csv_to_bq = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='custom-vigil-346206.health_data_global.global_data',  # Replace with your project, dataset, and table name
        source_format='CSV', 
